...
export default class ProductView {
        ...
        productList.forEach(product => {
            ...
            listItem.append(
                ...
                this.createProductText(
                    this.formatProductDate(product),
                    "basis-[16%] font-vazir ww:text-base xx:text-[15px] dd:text-[14px] ss:text-[13px]"
                ),
                this.createProductQuantityControls(product),
    ...
    sortBySelect(sortType) {
        ...
        if (sortType === "newest") {
            sortedProducts = savedProducts.slice().sort((a, b) => b.id - a.id)
        } else if (sortType === "oldest") {
            sortedProducts = savedProducts.slice().sort((a, b) => a.id - b.id)
        } else if (sortType === "A-Z") {
            sortedProducts = savedProducts.slice().sort((a, b) =>
    ...
    createProductQuantityControls(product) {
